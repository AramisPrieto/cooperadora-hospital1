...
│   │   ├── ForgotPassword.jsx  # Formulario para solicitar enlace de recuperación de clave
...
│   │   ├── ResetPassword.jsx   # Formulario para ingresar nueva contraseña con validaciones
│   │   ├── SocioPanel.jsx      # Panel privado del socio (Cuotas, Donaciones, Perfil)
│   │   └── TermsAndConditions.jsx # Términos y condiciones legales de uso y política de datos (Ley 25.326)
...
* **Vercel Analytics (`@vercel/analytics`):** Realiza un seguimiento anónimo del tráfico, cantidad de visitantes únicos y páginas más visitadas. Se monta como `<Analytics />` en [App.jsx](src/App.jsx).
* **Vercel Speed Insights (`@vercel/speed-insights`):** Recopila y analiza los Core Web Vitals (LCP, FID, CLS, etc.) de usuarios reales sin interferir en la velocidad de la página. Se monta como `<SpeedInsights />` en [App.jsx](src/App.jsx).
