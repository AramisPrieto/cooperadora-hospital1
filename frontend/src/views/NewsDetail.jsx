            ...
            <div className="lg:col-span-8 space-y-6">
              ...
              {noti.tags && noti.tags.length > 0 && (
                <div className="flex flex-wrap gap-2 pt-6 border-t border-slate-100">
                  {noti.tags.map(tag => (
                    <span key={tag} className="badge badge-slate text-[10px] font-black tracking-wider uppercase">
                      #{tag}
                    </span>
                  ))}
                </div>
              ...
              <div className="bg-slate-50 rounded-3xl p-6 border border-slate-250/20 space-y-4">
                ...
                <div className="space-y-3.5 text-xs">
                  <div className="flex justify-between items-center text-slate-500 font-semibold">
                    <span>Área:</span>
                    <span className="text-slate-800 font-black">{category}</span>
                  </div>
                  <div className="flex justify-between items-center text-slate-500 font-semibold">
                    <span>Publicado:</span>
                    <span className="text-slate-800 font-black">{formatLongDate(noti.fecha)}</span>
                  </div>
                  <div className="flex justify-between items-center text-slate-500 font-semibold">
                    <span>Lectura:</span>
                    <span className="text-slate-800 font-black inline-flex items-center gap-1">
