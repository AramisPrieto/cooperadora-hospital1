...
const walkthoughPath = process.env.INPUT || path.resolve(process.cwd(), 'walkthrough.md');
const outputPath = process.env.OUTPUT || path.resolve(process.cwd(), 'Reporte_QA_y_Seguridad.pdf');
