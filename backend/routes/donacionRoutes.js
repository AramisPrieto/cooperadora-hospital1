...
import { validateDonation, validateSqlId } from '../middleware/validators.js';
...
router.post('/campanas/:id/donar-transferencia', authenticateJWT, validateSqlId('id'), donationLimiter, validateDonation, declararTransferencia);
router.post('/campanas/:id/donar-mp', authenticateJWT, validateSqlId('id'), donationLimiter, validateDonation, crearDonacionMercadoPago);
...
router.put('/transferencias/:id/aprobar', authenticateJWT, authorizeRoles('admin'), validateSqlId('id'), aprobarTransferencia);
router.put('/transferencias/:id/rechazar', authenticateJWT, authorizeRoles('admin'), validateSqlId('id'), rechazarTransferencia);
